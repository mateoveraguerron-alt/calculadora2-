         ...
         <TextField value={pantalla} disabled variant="outlined"  sx={{ mb:2 , color:"#000000ff", input : { textAlign : "right", color:"#000" }, "& .MuiOutlinedInput-root": {
              ...
              <Grid container spacing={1} sx={{display:"flex" , justifyContent:"center" , alignItems:"center", textAlign:"center" , alignSelf:"center"}}>
                <Grid item xs={3}>
                  ...
                  <Grid item xs={3}><ButtonMotion fullWidth onClick={() => agregar("1")} sx={{color:"black", border:"1px solid #000000ff", height: {xl:60 , md:55 , xs:50} , fontSize:{xl:"1.1rem" , md:"1.5rem" , xs:"0.9rem" }}}whileHover={{scale:1.1}}>1</ButtonMotion></Grid>
                  <Grid item xs={3}><ButtonMotion fullWidth onClick={() => agregar("2")} sx={{color:"black", border:"1px solid #000000ff", height:  {xl:60 , md:55 , xs:50} , fontSize:{xl:"1.1rem" , md:"1.5rem" , xs:"0.9rem" }}}whileHover={{scale:1.1}}>2</ButtonMotion></Grid>
                  <Grid item xs={3}><ButtonMotion fullWidth onClick={() => agregar("3")} sx={{color:"black", border:"1px solid #000000ff", height:  {xl:60 , md:55 , xs:50} , fontSize:{xl:"1.1rem" , md:"1.5rem" , xs:"0.9rem" }}}whileHover={{scale:1.1}}>3</ButtonMotion></Grid>
                  ...
                  <Grid item xs={3}><ButtonMotion fullWidth onClick={() => agregar("-")} sx={{color:"#fff", border:"1px solid #ffffffff" , background:"#747dffff", height: {xl:60 , md:55 , xs:50} , fontSize:{xl:"1.5rem" , md:"1.5rem" , xs:"0.9rem" }}}whileHover={{scale:1.1}}>-</ButtonMotion></Grid>
                  <Grid item xs={3}><ButtonMotion fullWidth onClick={() => agregar("7")} sx={{color:"black", border:"1px solid black", height:  {xl:60 , md:55 , xs:50} , fontSize:{xl:"1.1rem" , md:"1.5rem" , xs:"0.9rem" } }}whileHover={{scale:1.1}} >7</ButtonMotion></Grid>
                  <Grid item xs={3}><ButtonMotion fullWidth onClick={() => agregar("8")} sx={{color:"black", border:"1px solid black", height:  {xl:60 , md:55 , xs:50} , fontSize:{xl:"1.1rem" , md:"1.5rem" , xs:"0.9rem" }}} whileHover={{scale:1.1}}>8</ButtonMotion></Grid>
                  <Grid item xs={3}><ButtonMotion fullWidth onClick={() => agregar("9")} sx={{color:"black", border:"1px solid black", height:  {xl:60 , md:55 , xs:50} , fontSize:{xl:"1.1rem" , md:"1.5rem" , xs:"0.9rem" }}} whileHover={{scale:1.1}}>9</ButtonMotion></Grid>
